            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{URL::to('images/User.png')}}" alt="user icon" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('mesdonnees')}}" class="nav-item nav-link"><i class="fa fa-database me-2"></i>Mes données</a>
                    <a href="{{route('moncode')}}" class="nav-item nav-link"><i class="fa fa-lock me-2"></i>Mon Code</a>
                    <div class="nav-item dropdown">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{URL::to('images/User.png')}}" alt="user icon" style="width: 40px; height: 40px;">
