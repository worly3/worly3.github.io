...
<head>
    ...
    <link rel="stylesoeet" href="{{ URL::asset('css/owl.theme.default.min.css') }}">
...
<body>
    ...
    <div class="banner_bg_main">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="custom_menu">
                            <ul>
                                <li><a class="{{ Helper::activeLink(['index']) }}"
                                        href="{{ route('index') }}">Accueil</a></li>
                                <li><a class="{{ Helper::activeLink(['aboutus']) }}"
                                        href="{{ route('aboutus') }}">A-Propos</a></li>
                                <li><a class="{{ Helper::activeLink(['contactus']) }}"
                                        href="{{ route('contactus') }}">Nous Contacter</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="logo_section">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="{{ route('index') }}"><img src="images/worly15.png"></a></div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="buynow_bt"><a href="#">COMMANDER MAINTENANT</a></div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="copyright_section">
        <div class="container">
            <p class="copyright_text">© <span id="copyright_year"></span> All Rights Reserved.</p>
        </div>
    </div>
